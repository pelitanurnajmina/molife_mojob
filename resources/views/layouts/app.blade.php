    ...
    <aside class="hidden md:flex w-64 bg-white border-r border-gray-100 flex-col p-6 fixed top-0 left-0 h-screen z-10 overflow-y-auto">
        ...
        <nav class="flex-1">
            ...
            $lifeNav = array_merge($lifeNav, [
                ...
                ['route'=>'ide-script', 'feat'=>'ide_script',   'label'=>__('Ide & Script'),    'match'=>'ide-script',  'icon'=>'M9.663 17h4.673M12 3a6 6 0 00-3.6 10.8c.44.33.6.87.6 1.42V16a1 1 0 001 1h4a1 1 0 001-1v-.78c0-.55.16-1.09.6-1.42A6 6 0 0012 3z'],
