...
<div class="space-y-4 md:space-y-6">
    ...
    {{-- History --}}
    @if(count($dailyHistory) > 0 || count($weeklyHistory) > 0)
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
        {{-- Daily history --}}
        <div class="bg-white rounded-2xl md:rounded-3xl p-4 md:p-8">
            ...
            @empty
            <p class="text-center text-gray-400 text-sm py-6">{{ __('Belum ada riwayat harian') }}</p>
            @endforelse
        </div>
        ...
        <div class="bg-white rounded-2xl md:rounded-3xl p-4 md:p-8">
            ...
            @empty
            <p class="text-center text-gray-400 text-sm py-6">{{ __('Belum ada riwayat mingguan') }}</p>
            @endforelse
        </div>
    </div>
    @endif
