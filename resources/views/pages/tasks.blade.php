...
<div class="space-y-4 md:space-y-6">
    ...
    <a href="{{ route('tasks.history') }}"
        class="block bg-white rounded-2xl md:rounded-3xl p-4 md:p-5 border border-gray-50 hover:shadow-sm transition-all">
        <div class="flex items-center gap-3">
            ...
            <div class="flex-1 min-w-0">
                <p class="text-sm font-bold text-gray-800">{{ __('Riwayat Task') }}</p>
                <p class="text-xs text-gray-400">{{ __('Lihat penyelesaian task harian & mingguan sebelumnya') }}</p>
            </div>
