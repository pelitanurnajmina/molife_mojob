...
<div class="space-y-4 md:space-y-6">
    ...
    <div class="bg-white rounded-2xl md:rounded-3xl p-4 md:p-8">
        ...
        <div class="flex flex-wrap gap-2">
            @php
                $shareText = rawurlencode(__('Yuk pakai Mojob buat track hidup & karir kamu! Daftar lewat link aku:') . ' ' . $link);
            @endphp
            ...
            <a href="https://t.me/share/url?url={{ rawurlencode($link) }}&text={{ rawurlencode(__('Yuk pakai Mojob!')) }}" target="_blank"
